...
NEED_Plot <- data.frame("NEED_TYPE"=NEED_data_typecast$PROP_TYPE, "NEED_AGE_BANDS"=NEED_data_typecast$PROP_AGE_FINAL, "E_TOT" = NEED_data_typecast$E_INT+NEED_data_typecast$G_INT, "group"=NEED_data_typecast$group)
