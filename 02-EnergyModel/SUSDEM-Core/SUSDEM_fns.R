...
# subFN: Temperatures ################################
input_weather@ExternalTemp, input_weather@GroundTemp, input_SP@THeating, input_SP@TCooling, TimeLength, DwellingType, DwellingPosition
...
#cooling
Tih = input_SP@THeating
Tic = input_SP@TCooling 
TimeStep = input_Constants@Time[,1]
...
GainRatio = HeatGainRatio
LossRatio = HeatLossRatio
Thermal = input_constructions@ThermalMass
TotalArea = input_geometry@TotalArea
